             ...
             <div class="card">
                 <div class="card-body p-4 d-flex flex-column justify-content-center align-items-stretch" style="height: 100%;">
                     ...
                     <div class ="row">
                         <div  class =" col-md-4">
                             <div class="form-group">
                                 ...
                                 <asp:TextBox CssClass="form-control w-100" ID="TextBox8" runat="server" placeholder="User ID" ReadOnly="True" />
                             </div>
                         </div>
                         ...
                         <div  class =" col-md-4">
                             <div class="form-group">
                                 ...
                                 <asp:TextBox CssClass="form-control w-100" ID="TextBox9" runat="server" placeholder="Old Password" TextMode="Password" ReadOnly="True" />
                             </div>
                         </div>
                         ...
                         <div  class =" col-md-4">
                             <div class="form-group">
                                 ...
                                 <asp:TextBox CssClass="form-control w-100" ID="TextBox5" runat="server" placeholder="Enter User Password" TextMode="Password" />
                             </div>
                         </div>
                     ...
                     <div class="form-group mt-3">
                         <asp:Button CssClass="btn btn-primary w-100 btn-lg" ID="ButtonLogin" runat="server" Text="Update" />
                     </div>
         ...
         <div class ="col-md-7">
             ...
             <div class="card">
                 <div class="card-body p-4 d-flex flex-column justify-content-center align-items-stretch" style="height: 100%;">
                     <!-- Book Icon -->
                     <div class="text-center mb-3">
                         <img src="/Content/imgs/stackedbook.png" style="width:100px" alt="User Icon" />
                     </div>
